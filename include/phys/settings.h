...
#define PE_ROPE_DEFAULT_LENGTH 1.0f
#define PE_ROPE_DEFAULT_STRENGTH 1.0f
#define PE_ROPE_DEFAULT_BREAK_FORCE 5.0f
#define PE_ROPE_MAX_FORCE_FACTOR 0.05f
#define PE_ROPE_SMOOTHING 2.0f
